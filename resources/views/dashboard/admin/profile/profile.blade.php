                        ...
                        <form action="{{ route('update_profile', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <img src="{{ URL::to('/') }}/gambar/{{ $user->photo }}" class="rounded-circle" width="120px" height="120px" alt="Avatar">
                            ...
                            <div class="d-md-flex justify-content-md-end mt-4">
                                ...
                                <a href="/dashboard" class="btn btn-outline-secondary ms-4">Close<i class="bi bi-x-lg ms-2"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
